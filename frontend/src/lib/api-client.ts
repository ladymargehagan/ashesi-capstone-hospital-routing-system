...
export const usersApi = {
    ...
    updateProfile: (id: string, data: { first_name?: string; last_name?: string; phone_number?: string; title?: string; license_number?: string; specialization?: string; department?: string; grade?: string; }) =>
        apiFetch<{ success: boolean }>(
